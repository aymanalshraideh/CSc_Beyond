    ...
    <div class="container-fluid">
        <div class="row">
            ...
            if(isset($_POST['submit'])){
                ...
                $ss="UPDATE courses SET title='$title' ,description='$description'    WHERE id='$id'";
                $conn->query($ss) ;
                                        ...
                                        <form class="mx-1 mx-md-4" method="post" action=''>
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="text" id="form3Example1c" value='<?php echo $value['title']; ?>' name='title' class="form-control" />
                                            ...
                                            <div class="d-flex flex-row align-items-center mb-4">
                                                ...
                                                <div class="form-outline flex-fill mb-0">
                                                    ...
                                                    <input type="text" id="form3Example1c" value='<?php echo $value['description']; ?>' name='description' class="form-control" />

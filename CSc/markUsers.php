...
//get all Courses
$sqlcours = "SELECT * FROM courses ";
$result1 = mysqli_query($conn, $sqlcours);
$courses = mysqli_fetch_all($result1, MYSQLI_ASSOC);
//****************** */
$sqlstu = "SELECT * FROM users ";
$result2 = mysqli_query($conn, $sqlstu);
$students = mysqli_fetch_all($result2, MYSQLI_ASSOC);
//get all students
if (isset($_POST['submit'])) {
    ...
    $sql = 'INSERT INTO marks (user_id,cours_id,mark) VALUES (?,?,?)';
    $stInsert = $conn->prepare($sql);
    $result = $stInsert->execute([ $userId, $coursId,$mark]);
    $_SESSION['mark'] = 'sss';
}
//********************  */
?>
                                ...
                                <div class="col-md-8">
                                    <div class="card mb-3">
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="number" class="form-control" name='mark' id="exampleFormControlInput1">
                                                    </div>
                                                </div>
                                            </div>
                                            <hr>
                                                ...
                                                <div class="col-sm-9 text-secondary">
                                                    <div class="mb-3">
                                                        ...
                                                        <div class="form-outline flex-fill mb-0">
                                                            ...
                                                            <select class="form-select" name='cours_id' aria-label="Default select example">
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <button type="submit" name='submit' class="btn btn-primary btn-lg">Add Cours</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
